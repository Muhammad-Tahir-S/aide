import { BookMarked, ListTodo, type LucideIcon } from "lucide-react";
...
export const SIDEBAR_CHROME: SidebarChromeStyle = {
  ...
  itemHover: "hover:bg-primary-25 hover:text-primary-main",
  itemActive: "hover:bg-transparent",
  itemLabel: "text-[13px] font-medium",
  icon: ListTodo,
  notesIcon: BookMarked,
  iconClass: "size-4",
  tooltip: "bg-gray-800 text-base-light border-0",
  tooltipArrow: true,
  tooltipArrowClass: "bg-gray-800 fill-gray-800",
  tooltipDelay: 180,
  control: "text-gray-500 hover:bg-primary-25 hover:text-primary-main",
  menu: "bg-base-light border-gray-200",
  menuItem: "hover:bg-primary-25 hover:text-primary-main",
  menuItemActive: "bg-primary-25 text-primary-main",
  profile: "hover:bg-primary-25",
  overlayShadow: true,
};
